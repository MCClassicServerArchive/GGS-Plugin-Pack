...
public class IRCHandler {
	...
	/**
	 * Gets the user who said the current line.
	 */
	...
	/**
	 * Gets the message of the current line.
	 */
	...
	/**
	 * Checks if the current line has the specified reply code.
	 * 
	 * @param line
	 *             The line to check.
	 * @param code
	 ...
	 * 
	 * @return A boolean indicating whether the specified line contains the specified reply code.
	 */
